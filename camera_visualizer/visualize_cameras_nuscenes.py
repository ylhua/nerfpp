...
def visualize_cameras(colored_camera_dicts, sphere_radius, camera_size=0.1, geometry_file=None, geometry_type='mesh'):
    ...
    for color, camera_dict in colored_camera_dicts:
        ...
        for img_name in camera_dict:
            ...
            C2W = np.array(img_name['C2W']).reshape((4, 4))
...
if __name__ == '__main__':
    ...
    sphere_radius = 1.
    train_cam_dict = json.load(open(os.path.join(base_dir, 'F:/null_max/label_manual/nerfplusplus/nuscenes/all_train.json')))
    test_cam_dict = json.load(open(os.path.join(base_dir, 'F:/null_max/label_manual/nerfplusplus/nuscenes/all_test.json')))
    path_cam_dict = json.load(open(os.path.join(base_dir, 'F:/null_max/label_manual/nerfplusplus/nuscenes/all_train.json')))
    camera_size = 0.1
